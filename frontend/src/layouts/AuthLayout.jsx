        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-600">
              ...
              <Link to="/terms" className="text-violet-700 hover:underline">
                Terms of Service
              </Link>{' '}
              and{' '}
        ...
        <div className="flex flex-col justify-center max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-white/20">
            <div>
              ...
              <div className="text-violet-100 text-sm">Doctors</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-1">10K+</div>
              <div className="text-violet-100 text-sm">Patients</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-1">50K+</div>
              <div className="text-violet-100 text-sm">Consultations</div>
            </div>
          </div>
        </div>
      </div>
